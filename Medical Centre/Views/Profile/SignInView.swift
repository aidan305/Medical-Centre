...
struct SignInView: View {
    ...
    init() {
        UINavigationBar.appearance().largeTitleTextAttributes = [.foregroundColor: UIColor.init(named: "PrimaryBlue") ?? Color.purple] //changing the color of the navigation bar title
    }
